      ...
      <nav class="app-sidebar">
        <div class="project-header">
          ...
          <div class="project-info">
            <span class="project-info-name"> {{ getCurrentProjectPage?.name }} </span>
            <span class="project-info-subtitle text-body-3"> {{ getCurrentProjectPage?.category }} Project </span>
          </div>
        </div>
        <JList>
          <router-link :to="`/project/${getCurrentProjectPage?.key}/board`">
            <JListItem>
              <JIcon
                v-bind="iconsConfig"
                icon="board"
          ...
          <router-link :to="`/project/${getCurrentProjectPage?.key}/settings`">
            <JListItem>
              <JIcon
                v-bind="iconsConfig"
                icon="settings"
